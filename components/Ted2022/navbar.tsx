...
export const Navbar = ({selected}) => {
    ...
    return (
      <nav className={styles.navbar}>  
        ...
        <Link href="/ted2022/programs"><a>Program</a></Link>
        <Link href="/ted2022/speakers"><a className={pageSelect[2]}>Speakers</a></Link>
        <Link href="/ted2022/partners"><a className={pageSelect[3]}>Partners</a></Link>
        {/* <Link href="/"><a>Speakers</a></Link>
